...
public final class VectorType extends _eEnumBase
{
    public VectorType ()
    {
    }

    public VectorType (int _lArg1)
    {
        super (_lArg1);
    }
    ...
    public static _eSeq _oRange (int _lArg1, int _lArg2)
    {
        ...
        while (_lArg1 <= _lArg2) _lResult = _lResult._lAppend (new VectorType (_lArg1 ++));
        return _lResult;
    }

    public final static int Position = 0, Velocity = 1, Distance = 2;
