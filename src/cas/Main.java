...
final class _jMain
{
        ...
        _eWrapper_int ret)
    {
        ...
        _eSeq _vLet_initialCrafts_14_13 = new _eSeq ()._lAppend (((_eAny) new Aircraft (new Vector (
            ...
            AircraftModel) null)), ((_eAny) new Aircraft (new Vector (67.0, 5.0, 3434.0, VectorType.
            Position, (VectorType) null), new Vector (54.0, 146.0, 0.0, VectorType.Velocity, (
            VectorType) null), 20.0, AircraftStatus.FlyingAtLevel, (AircraftStatus) null, _eSystem.
            _lString ("B"), (char) 0, AircraftModel.Boeing777200, (AircraftModel) null)), ((_eAny)
            new Aircraft (new Vector (879.0, 664.0, 7834.0, VectorType.Position, (VectorType) null),
            new Vector (265.0, 86.0, 0.0, VectorType.Velocity, (VectorType) null), 30.0,
            AircraftStatus.FlyingAtLevel, (AircraftStatus) null, _eSystem._lString ("C"), (char) 0,
            AircraftModel.Boeing777200, (AircraftModel) null)), ((_eAny) new Aircraft (new Vector (
            435.0, 234.0, 45534.0, VectorType.Position, (VectorType) null), new Vector (342.0, 134.0,
            0.0, VectorType.Velocity, (VectorType) null), 25.0, AircraftStatus.FlyingAtLevel, (
            AircraftStatus) null, _eSystem._lString ("D"), (char) 0, AircraftModel.Boeing777200, (
            AircraftModel) null)))._lAppend (((_eAny) new Aircraft (new Vector (7568.0, 6675.0,
            34456.0, VectorType.Position, (VectorType) null), new Vector (57.0, 75.0, 0.0,
            VectorType.Velocity, (VectorType) null), 35.0, AircraftStatus.FlyingAtLevel, (
            AircraftStatus) null, _eSystem._lString ("E"), (char) 0, AircraftModel.Boeing777200, (
            AircraftModel) null)), ((_eAny) new Aircraft (new Vector (453.0, 5753.0, 3468.0,
            VectorType.Position, (VectorType) null), new Vector (23.0, 105.0, 0.0, VectorType.
            Velocity, (VectorType) null), 10.0, AircraftStatus.FlyingAtLevel, (AircraftStatus) null,
            _eSystem._lString ("F"), (char) 0, AircraftModel.Boeing777200, (AircraftModel) null)), (
            (_eAny) new Aircraft (new Vector (987.0, 5342.0, 344.0, VectorType.Position, (VectorType)
            null), new Vector (364.0, 63.0, 0.0, VectorType.Velocity, (VectorType) null), 5.0,
            AircraftStatus.FlyingAtLevel, (AircraftStatus) null, _eSystem._lString ("G"), (char) 0,
    ...
    {
        _eSeq _vForYield_44_18 = new _eSeq ();
        {
            int _vCaptureCount_a_44_33 = system.aircrafts._oHash ();
            int _vLoopCounter_44_23 = 0;
            for (;;)
            {
                if ((_vLoopCounter_44_23 == _vCaptureCount_a_44_33)) break;
                _vForYield_44_18 = _vForYield_44_18.append (((_eAny) _eSystem._ltoString (((Aircraft)
                    system.aircrafts._oIndex (_vLoopCounter_44_23)).boundaryRadius)));
                _vLoopCounter_44_23 = _eSystem._oSucc (_vLoopCounter_44_23);
            }
        }
        _eSeq _vOver_44_12 = new _eSeq ();
        {
            int _vLoopCounter_44_12 = 0;
            for (;;)
            {
                if ((_vForYield_44_18._oHash () == _vLoopCounter_44_12)) break;
                _vOver_44_12 = ((_eSeq) _vOver_44_12._lClone ());
                _vOver_44_12._osPlusPlus (((_eSeq) _vForYield_44_18._oIndex (_vLoopCounter_44_12)),
                    (_eTemplate_0) null);
                _vLoopCounter_44_12 = _eSystem._oSucc (_vLoopCounter_44_12);
            }
        }
        return _vOver_44_12;
    }
