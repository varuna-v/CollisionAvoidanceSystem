...
public class CASystem extends _eAny
{
    ...
    {
        return atc.getMinimumTimeToConflict ();
    }
    ...
    public void changeHeight (_eSeq identification, char _t0identification, double targetHeight)
    {
        ...
        atc = _vUnshare_27_14;
        _vUnshare_27_14.changeCraftHeight (identification, (char) 0, targetHeight);
    }
    ...
    public void fly ()
    {
        ...
        atc = _vUnshare_30_14;
        _vUnshare_30_14.fly (CASystem.defaultTimeToFlyFor);
    }

    public void addAircraft (Aircraft aircraft)
    {
        AirTrafficController _vUnshare_33_14 = ((AirTrafficController) atc._lClone ());
        atc = _vUnshare_33_14;
        _vUnshare_33_14.addAircraft (aircraft);
    }
