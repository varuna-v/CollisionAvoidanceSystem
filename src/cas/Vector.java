...
public class Vector extends _eAny
{
    ...
    public double getDistanceFrom (Vector other)
    {
        if (_eSystem.enablePre && _eSystem.currentCheckNesting <= _eSystem.maxCheckNesting)
        {
            _eSystem.currentCheckNesting ++;
        ...
        return _eSystem._oExp (((_eSystem._oExp ((x - other.x), 2) + _eSystem._oExp ((y - other.y),
            2)) + _eSystem._oExp ((z - other.z), 2)), 0.5);
    }
    ...
    {
        return _eSystem._lString ("(")._oPlusPlus (_eSystem._ltoString (_eSystem.rounddn (x)), (
            _eTemplate_0) null)._oPlusPlus (_eSystem._lString (")x + ("), (_eTemplate_0) null).
            _oPlusPlus (_eSystem._ltoString (_eSystem.rounddn (y)), (_eTemplate_0) null)._oPlusPlus
            (_eSystem._lString (")y + ("), (_eTemplate_0) null)._oPlusPlus (_eSystem._ltoString (
            _eSystem.rounddn (z)), (_eTemplate_0) null)._oPlusPlus (_eSystem._lString (")z"), (
            _eTemplate_0) null);
    }
