...
#if !defined(_hMain_ConflictStatus)
#define _hMain_ConflictStatus

// Full declarations


extern const _eMDH * _agetObjLoaderNode_ConflictStatus ();
namespace ConflictStatus
{
    _mEnumMembers _mEnumWrapper
}

_mEnumGlobalSupport (ConflictStatus)
_mUserTypeInform (ConflictStatus :: _eEnum, _agetObjLoaderNode_ConflictStatus (), 0)
